...
VALUES 
('jdoe', 'John', 'Doe', 'jdoe@example.com', 'hashed_password1', 3),
...
VALUES 
('Leonardo', 'DiCaprio', 'An acclaimed actor.', '1974-11-11', 'male', 'US'),
...
VALUES 
('Inception', 'A mind-bending thriller.', '2010-07-16', 160000000, 148, 1, 6, 'US'),
...
VALUES 
(1, 1), -- jdoe likes Inception
(1, 3), -- jdoe likes Interstellar
(2, 2), -- asmith likes The Matrix
(3, 4), -- bclark likes Black Swan
(4, 5); -- mjones likes Joker

-- ERROR

SELECT * FROM unknown_actor


INSERT INTO unknown_actor (first_name, last_name, role_description)
VALUES 
('Mog', 'Irg', 'Background actor with no specific role.'),
('Kol', 'Dag', 'Background actor with no specific role.'),
('Log', 'Mag', 'Extra in several scenes.');


INSERT INTO actor (person_id, unknown_actor_id)
VALUES 
(1, NULL), -- Leonardo DiCaprio
...
INSERT INTO character (character_name, description, role, actor_id, movie_id)
VALUES 
...
INSERT INTO person_file (file_id, person_id, is_primary)
VALUES 
